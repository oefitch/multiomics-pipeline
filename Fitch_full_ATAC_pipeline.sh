...
parallel 'bowtie2  --very-sensitive  -x gar_index  -1 {}_pe_bbtrimmed_1.fq -2 {}_pe_bbtrimmmed_2.fq -S {}.sam' ::: $sample_names
...
parallel 'samtools view -h  {}_sorted.bam  |  python path/removeChrom.py - - MT  |  samtools view -b | samtools sort - > {}_sorted_mitout.bam' ::: $sample_names

#### Remove PCR Duplicates #### 
#NOTE: sometimes you have to sort again after this
parallel 'java -jar path/picard.jar MarkDuplicates I={}_sorted_mitout.bam O={}_sorted_mitout_dupout.bam M={}_dups.txt REMOVE_DUPLICATES=true' ::: $sample_names
